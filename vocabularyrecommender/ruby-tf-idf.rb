...
module RubyTfIdf
  ...
  class TfIdf
    ...
    STOP_WORDS_CZ = [
      ...
      "zde","ze","zprávy","zpět","čau","či","článku","články","čtrnáct","čtyři","šest","šestnáct","že"
    ]
      ...
      def compute_tf_idf(limit,exlude_stop_words)
        ...
        @tf.each do |tf_freq|
          ...
          if (exlude_stop_words == true)
            ...
            tfidf.reject!{ |k| STOP_WORDS_CZ.include?(k) == true }
            tfidf.reject!{ |k| STOP_WORDS_SK.include?(k) == true }
          end
